# PlayList Maker - создание плейлистов из базы бесплатных сэмплов сервиса iTunes
### Учебный проект в рамках курса Android разработчик на Яндекс.Практикум
...
![Static Badge](https://img.shields.io/badge/Room-blue)
...
### Приложение позволяет искать превью треков на iTunes и вопроизводить их. Добавлять треки в плейлисты и сохранять их на устройстве.
### плейлисты и данные о треках в них сохраняются в локальную базу на устройстве
